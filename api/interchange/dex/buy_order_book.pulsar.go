...
func init() {
	...
	md_BuyOrderBook = File_interchange_dex_buy_order_book_proto.Messages().ByName("BuyOrderBook")
...
func (x *BuyOrderBook) slowProtoReflect() protoreflect.Message {
	mi := &file_interchange_dex_buy_order_book_proto_msgTypes[0]
...
func (x *fastReflection_BuyOrderBook) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "interchange.dex.BuyOrderBook.index":
		return x.Index != ""
	case "interchange.dex.BuyOrderBook.amountDenom":
		return x.AmountDenom != ""
	case "interchange.dex.BuyOrderBook.priceDenom":
		return x.PriceDenom != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: interchange.dex.BuyOrderBook"))
		}
		panic(fmt.Errorf("message interchange.dex.BuyOrderBook does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderBook) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message interchange.dex.BuyOrderBook does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderBook) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "interchange.dex.BuyOrderBook.index":
		panic(fmt.Errorf("field index of message interchange.dex.BuyOrderBook is not mutable"))
	case "interchange.dex.BuyOrderBook.amountDenom":
		panic(fmt.Errorf("field amountDenom of message interchange.dex.BuyOrderBook is not mutable"))
	case "interchange.dex.BuyOrderBook.priceDenom":
		panic(fmt.Errorf("field priceDenom of message interchange.dex.BuyOrderBook is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: interchange.dex.BuyOrderBook"))
		}
...
func (x *fastReflection_BuyOrderBook) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in interchange.dex.BuyOrderBook", d.FullName()))
	}
	panic("unreachable")
}
...
func (*BuyOrderBook) Descriptor() ([]byte, []int) {
	return file_interchange_dex_buy_order_book_proto_rawDescGZIP(), []int{0}
}
...
var File_interchange_dex_buy_order_book_proto protoreflect.FileDescriptor

var file_interchange_dex_buy_order_book_proto_rawDesc = []byte{
	,
...
var (
	file_interchange_dex_buy_order_book_proto_rawDescOnce sync.Once
	file_interchange_dex_buy_order_book_proto_rawDescData = file_interchange_dex_buy_order_book_proto_rawDesc
)

func file_interchange_dex_buy_order_book_proto_rawDescGZIP() []byte {
	file_interchange_dex_buy_order_book_proto_rawDescOnce.Do(func() {
		file_interchange_dex_buy_order_book_proto_rawDescData = protoimpl.X.CompressGZIP(file_interchange_dex_buy_order_book_proto_rawDescData)
	})
	return file_interchange_dex_buy_order_book_proto_rawDescData
}

var file_interchange_dex_buy_order_book_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_interchange_dex_buy_order_book_proto_goTypes = []interface{}{
	(*BuyOrderBook)(nil), // 0: interchange.dex.BuyOrderBook
}
var file_interchange_dex_buy_order_book_proto_depIdxs = []int32{
...
func init() { file_interchange_dex_buy_order_book_proto_init() }
func file_interchange_dex_buy_order_book_proto_init() {
	if File_interchange_dex_buy_order_book_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_interchange_dex_buy_order_book_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_interchange_dex_buy_order_book_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_interchange_dex_buy_order_book_proto_goTypes,
		DependencyIndexes: file_interchange_dex_buy_order_book_proto_depIdxs,
		MessageInfos:      file_interchange_dex_buy_order_book_proto_msgTypes,
	}.Build()
	File_interchange_dex_buy_order_book_proto = out.File
	file_interchange_dex_buy_order_book_proto_rawDesc = nil
	file_interchange_dex_buy_order_book_proto_goTypes = nil
	file_interchange_dex_buy_order_book_proto_depIdxs = nil
}
